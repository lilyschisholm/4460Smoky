...
constructor(parentElement, data) {
    ...
    let colors = ['#a6cee3','#1f78b4','#b2df8a','#33a02c','#fb9a99','#e31a1c','#fdbf6f','#ff7f00','#cab2d6','#6a3d9a', '#fcba03', '#78da5fff', '#c7ffd4ff', '#f809d0ff', '#280564ff', '#0b5855ff', '#307b0dff', '#ff995aff', '#c73037ff', '#5be9e4ff'];
